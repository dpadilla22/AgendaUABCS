/**
 * NotificationScreen.js con Modo Oscuro
...
const Notificaciones = () => {
    ...
    return (
        ...
        style={[
          ...
          !isRead && [
            ...
            { 
              ...
              backgroundColor: isDark ? '#1a2332' : '#F8FAFE'
            }
          ]
        ]}
      ...
      >
        <View style={styles.cardHeader}>
          <View style={[styles.iconContainer, { backgroundColor: isDark ? colors.inputBg : '#F5F5DC' }]}>
            <Image 
              source={require("../assets/calendar.png")} 
              style={[styles.calendarIcon, { tintColor: '#4A90E2' }]} 
            />
          </View>
        ...
        <View style={[styles.cardFooter, { borderTopColor: colors.border }]}>
          <Text style={[styles.date, { color: colors.textSecondary }]}>{formatDate(item.dateCreated)}</Text>
          <View style={[styles.statusDot, { backgroundColor: isRead ? colors.textSecondary : '#4A90E2' }]} />
        </View>
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      <View style={[styles.emptyIconContainer, { backgroundColor: isDark ? colors.inputBg : '#F5F5DC' }]}>
        <Image 
          source={require("../assets/calendar.png")} 
          style={[styles.emptyCalendarIcon, { tintColor: '#4A90E2' }]} 
        />
      </View>
